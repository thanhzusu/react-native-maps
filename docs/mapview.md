...
| `customMapStyle` | `Array` |  | Adds custom styling to the map component. See [README](https://github.com/thanhzusu/react-native-maps#customizing-the-map-style) for more information.
